...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--data_path",
                                 ...
                                 default=os.path.join("/home/fyh/space/samba_share/datasets/KITTI", "raw_data"))
        self.parser.add_argument("--log_dir",
                                 type=str,
                                 help="log directory",
                                 default="/home/fyh/space/samba_share/monovit/log_dir")

        # TRAINING options
        self.parser.add_argument("--encoder",
                                 type=str,
                                 help="the encoder for depth estimation network",
                                 default="edgemono",
                                 choices=["resnet", "edgemono"])
        self.parser.add_argument("--decoder",
                                 type=str,
                                 help="the decoder for depth estimation network",
                                 default="depthdecoder")
        self.parser.add_argument("--lr_setting",
                                 type=str,
                                 help="the train setting of lr",
                                 default="monovit",
                                 choices=["monodepth", "actadepth"])
        # triplet loss
        ...
        self.parser.add_argument("--frame_ids",
                                 ...
                                 default=[0, -1, 1])
        # edgenext
        self.parser.add_argument('--classifier_dropout', default=0.0, type=float)
